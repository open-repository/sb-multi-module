package io.nio.book.controller;

import io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker;
import io.nio.author.entity.Author;
import io.nio.author.proxy.AuthorSearchProxy;
import io.nio.book.entity.Book;
...
public class BookController {
    ...
    public ResponseEntity<Book> findAuthorsOfBook(@PathVariable long isbn){
        ...
        ResponseEntity<List> listResponseEntity = httpClient.getForEntity("http://AUTHOR/author/search/isbn/{isbn}",List.class,isbn);
    ...
    public ResponseEntity<Book> findAuthorsOfBook_fallback(@PathVariable long isbn,Throwable t){
        ...
        Book book = new Book(0,"norecord","norecord",null);
        bookResponseEntity = new ResponseEntity<>(book,HttpStatus.OK);
        return bookResponseEntity;
    }
